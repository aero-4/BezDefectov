...
export default function Admin(): JSX.Element {
    const [active, setActive] = useState<'lessons' | 'cards' | 'users'>('lessons');
    ...
    return (
        <section>
            ...
            <table className="w-full text-sm">
                <thead><tr className="border-b"><th>ID</th><th>Duration</th><th>Type</th><th /></tr></thead>
                <tbody>
                {lessons.map(l => (
