...
class Prompts(enum.StrEnum):
    ...
    _PROMPT_CARDS_TEMPLATE = " ".join([
        ...
        "По порядку. Добавить сложность скороговорок, слогов, предложений. Сделать разнообразие для тренировок убрать легкие карточки. Опять же запрет ставлю на генерацию простых карточек. Они должны быть сложные",
        "Язык: русский.",
        ...
        "От 200-300 карточек (карточкой является строка - Название карточки{sep_line}Текст).",
    ...
    _PROMPT_DIALOGS_TEMPLATE = " ".join([
        ...
        "Тематика: любая (из книги, из фильма, из сериала или фейковая). Диалоги должны быть со смыслом и больше 3 слов в одном предложении не касаясь приветствия! Также через 1-2 слова всегда должен отрабатываться дефект речи.",
        "Диалог всегда на 2 и более человек.",
        "Длина ВСЕГО диалога: от 100 до 200 реплик (от 2 и более говорящих персон).",
